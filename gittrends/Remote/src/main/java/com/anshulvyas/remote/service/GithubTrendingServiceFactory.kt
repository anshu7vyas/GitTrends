package com.anshulvyas.remote.service
...
class GithubTrendingServiceFactory {
    ...
    // implementation of the retrofit service interface
    ...
    // class that will handle the networking for Retrofit
    ...
    // Enable logging only if Debug build
